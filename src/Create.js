    ...
    <div className="row">
      <div className="col-md-6">
        <div className="form-group">
          ...
          <input name="name" onChange={formik.handleChange}  value={formik.values.name} type="text" className={`form-control ${formik.errors.name ? 'error-border' : " "}`} placeholder="" id="name" />
          {
      ...
      <div className="col-md-6">
        <div className="form-group">
          ...
          <input  name="position" onChange={formik.handleChange}  value={formik.values.position} type="text" className={`form-control ${formik.errors.position ? "error-border" : ""}`} placeholder="" id="position" />
          {
  ...
  formik.errors.office ? <span style={{color:"red"}}>{formik.errors.office}</span> : null 
      ...
      <div className="col-md-6">
        <div className="form-group">
          ...
          <input  name="age" onChange={formik.handleChange}  value={formik.values.age} type="tel" className={`form-control ${formik.errors.age ? 'error-border' : " "}`} id="phone" placeholder="" />
          {
    ...
    <div className="row">
      <div className="col-md-6">
        <div className="form-group">
          ...
          <input  name="startdate" onChange={formik.handleChange}  value={formik.values.startdate} type="date" className={`form-control ${formik.errors.startdate ? 'error-border' : " "}`} id="date" placeholder="" />
          {
  formik.errors.startdate ? <span style={{color:"red"}}>{formik.errors.startdate}</span> : null 
      ...
      <div className="col-md-6">
        <div className="form-group">
          ...
          <input  name="salary" onChange={formik.handleChange}  value={formik.values.salary} type="tel" className={`form-control ${formik.errors.salary ? 'error-border' : " "}`} id="salary" placeholder="" />
          {
